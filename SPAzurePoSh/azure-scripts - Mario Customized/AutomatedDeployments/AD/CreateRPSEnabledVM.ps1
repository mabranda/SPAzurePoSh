...
function CreateVM
{	
	#MB: removed AvailabilitySet parameter because this is just dev.
	...
	$vmConfig = New-AzureVMConfig -Name $vmName -InstanceSize $size -ImageName $imageName | Set-AzureSubnet -SubnetNames $subnetNames
